...
def elem(A,P,Rh,T,D,Z,ycg):
    print()
    print('Área mojada (A):', A)
    print('Perímetro mojado (P):', P)
    print('Radio hidráulico:', Rh)
    print('Ancho superficial:', T)
    print('Profundidad hidráulica:', D)
    print('Factor de sección:', Z)
    if seccion == 'Rectangular redondeada' or seccion == 'Triangular redondeada':
        print('No tenemos cálculo de profundidad centroidal.')
    else:
        print('Profundidad centroidal:', ycg)
