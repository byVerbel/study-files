...
/** My check_cycle function doesn't check for a cycle aside from the one that can be formed with the winner,
 * instead it should check for cycles that can exist with any candidate.
 * I would like to make an implementation with recursion for the check function but in the future,
 * I'll probably ask someone how do you solve it.**/
